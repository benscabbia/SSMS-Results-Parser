export class TableRowData {
    ...
    private _query1: number;
    private _query2: number;
    ...
    public get query1(): number {
        return this._query1;
    }

    public set query1(value: number) {
        this._query1 = value;
    }

    public get query2(): number {
        return this._query2;
    }

    public set query2(value: number) {
        this._query2 = value;
    }
